    ...
    <form method="POST" enctype="multipart/form-data" action="http://localhost/BTWeb/Nhom3_71DCTT24/DanhSachKhachHang/Action_KhachHang">
        ...
        <div class="content4">
            <table style="width: 100%;padding: 20px 20px 0px 20px; align-items:center;">
                <caption style="padding-top: 20px; font-size:24px"><b>QUẢN LÝ KHÁCH HÀNG</b></caption>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="txtMakh" value="" class="text_align" >
                    </td>
                </tr>
                <tr>
                    <td style="width:50%;padding-left:200px;">
                    ...
                    <td>
                        <input type="text" name="txtTenkh" value="" class="text_align" >
                    </td>
                </tr>
                <tr>
                    <td style="width:50%;padding-left:200px;">
                    ...
                    <td>
                        <input type="tel" name="txtTichdiem" value="" class="text_align" >
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <table style="position: center;width: 95%;margin-left:2.5%;border-color:blue;" cellspacing="1" border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['Tichdiem'] ?></td>
                        <td> <button class="button2">
                            <a href="http://localhost/BTWeb/Nhom3_71DCTT24/DanhSachKhachHang/SuaKhachHang/<?php echo $row['Makh'] ?>" style="display:flex;align-items:center">Sửa
                            <img src="http://localhost/BTWeb/Nhom3_71DCTT24/Public/Images/rong.png" height="30px" width="20px"></a>
                          </button></td>
                        <td>
                            <button class="button2">
                                <a href="http://localhost/BTWeb/Nhom3_71DCTT24/DanhSachKhachHang/btnXoaKhachHang/<?php echo $row['Makh'] ?>" style="display:flex;align-items:center">Xóa
                                    <img src="http://localhost/BTWeb/Nhom3_71DCTT24/Public/Images/rong.png" height="30px" width="20px"></a>
                            </button>
                        </td>
                    </tr>
            ...
            <div style="color: red;float:right;">
                <h4>Bảng danh sách các khách hàng</h4>
                &nbsp;&nbsp;
