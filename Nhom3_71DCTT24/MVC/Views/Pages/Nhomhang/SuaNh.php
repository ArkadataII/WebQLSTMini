    ...
    <form method="POST" enctype="multipart/form-data" action="http://localhost/BTWeb/Nhom3_71DCTT24/Dsnh/thucthi_nh">
        ...
        <div class="content4">
            <table style="width: 100%;padding: 20px 20px 0px 20px; align-items:center;margin-bottom:20px;">
                <caption style="padding-top: 20px; font-size:24px"><b>CẬP NHẬT THÔNG TIN NHÓM HÀNG</b></caption>
                <tr>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="txtManh" value="<?php  echo $r['Manh']; ?>" class="text_align" disabled>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:50%;padding-left:200px;">
                        ...
                        <td>
                            <input type="text" name="txtTennh" value="<?php  echo $r['Tennh']; ?>" class="text_align">
                        </td>
                    </tr>
